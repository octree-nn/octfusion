...
class UNet3DModel(nn.Module):
    ...
    def __init__(
        ...
        self.graph_downs.append(GraphConv(in_feature_channels, model_channels, n_edge_type, avg_degree, self.input_depth - 1))
    ...
    def forward(self, x_small, x_feature, doctree, timesteps1 = None, timesteps2 = None, context = None, y = None, **kwargs):
        """
        ...
        assert output_feature.shape[0] == x_feature.shape[0]
