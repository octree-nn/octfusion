...
class UNet3DModel(nn.Module):
    ...
    def forward(self, x, doctree_in, doctree_out, timesteps=None, context=None, y=None,**kwargs):
        """
        ...
        h = self.end(self.end_norm(h, doctree_out, d))

        out = self.out(h, doctree_out, d)

        if self.verbose:
            print(out.shape)
            print(d)

        return out, logits, doctree_out
