...
class UNet3DModel(nn.Module):
    ...
    def __init__(
        ...
        self.input_blocks = nn.ModuleList(
           [
              GraphConv(self.in_split_channels, model_channels, n_edge_type, avg_degree, self.large_depth - 1)
           ]
        )
        ...
        self.end = nn.SiLU()
        self.out = zero_module(GraphConv(model_channels, self.out_split_channels, n_edge_type, avg_degree, self.large_depth - 1))
    ...
    def forward(self, x_large, doctree, timesteps = None, context = None, y = None, **kwargs):
        """
        ...
        assert out.shape[0] == x_large.shape[0]
