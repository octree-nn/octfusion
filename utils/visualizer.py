...
class Visualizer():
    ...
    def display_current_results(self, visuals, current_iters, im_name='', phase='train'):
        ...
        for label, image_numpy in visuals.items():
            if phase == 'train':
                img_path = os.path.join(self.train_img_dir, f'{phase}_step{current_iters:05d}_{label}_{im_name}.png')
            elif phase == 'test':
                img_path = os.path.join(self.test_img_dir, f'{phase}_step{current_iters:05d}_{label}_{im_name}.png')
