...
for i in range(total_num):
    ...
    SDFusion.uncond(data = None, split_path = split_path, category = category, suffix = 'mesh_2t', ema = True, ddim_steps = ddim_steps, ddim_eta = ddim_eta, clean = True, save_index = i)
